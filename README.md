...
The difference between a stateful and  functional component is that a functional component does not maintain a remembered state value. It simple renders and is done. A stateful component remembers the value of a component and adjusts it to a new value as it's state is changed
